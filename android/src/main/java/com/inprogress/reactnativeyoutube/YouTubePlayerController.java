...
public class YouTubePlayerController implements
    ...
    void setupLayoutHack() {
        Choreographer.getInstance().postFrameCallback(new Choreographer.FrameCallback() {
            ...
            public void doFrame(long frameTimeNanos) {
                ...
                mYouTubeView.getViewTreeObserver().dispatchOnGlobalLayout();
    ...
    void manuallyLayoutChildren() {
        for (int i = 0; i < mYouTubeView.getChildCount(); i++) {
            View child = mYouTubeView.getChildAt(i);
            child.measure(View.MeasureSpec.makeMeasureSpec(mYouTubeView.getMeasuredWidth(), View.MeasureSpec.EXACTLY),
                    View.MeasureSpec.makeMeasureSpec(mYouTubeView.getMeasuredHeight(), View.MeasureSpec.EXACTLY));
    ...
    private void reLayout(View view) {
        if (view == null) return;
//        setupLayoutHack();
//        view.measure(View.MeasureSpec.makeMeasureSpec(view.getMeasuredHeight(), View.MeasureSpec.EXACTLY),
